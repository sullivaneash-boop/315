  ...
  return (
    <section id="booking" className="relative overflow-hidden bg-[var(--panel)] py-[clamp(4rem,10vw,9rem)]">
      <div className="mx-auto max-w-[640px] px-4 md:px-8">
        ...
        >
          <p className="text-misregister font-mono text-xs tracking-[0.3em] text-[var(--muted)]">BOOKING</p>
        ...
        >
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <button type="submit" className="mx-auto border border-[var(--chalk)] bg-transparent px-8 py-3 font-label text-sm font-bold tracking-[0.15em] text-[var(--chalk)] transition-all duration-[var(--fast)] hover:translate-x-[1px] hover:translate-y-[-1px] hover:bg-[var(--chalk)] hover:text-[var(--bg)]">SEND INQUIRY</button>
            </form>
          )}
        </motion.div>
      </div>
